      ...
      {ingredients.map((ingredient, index) => {
        ...
        return (
          <li className="relative font-bold" key={ingredient.id}>
            <label
              className="shadow-xs flex h-full cursor-pointer items-center rounded-md bg-white px-4 py-2 dark:bg-black"
              htmlFor={inputId}
            >
              ...
              <span className="rounded-xs mr-3 flex aspect-square w-5 shrink-0 items-center justify-center border-2 border-neutral-700 text-white peer-checked:border-green-600 peer-checked:bg-green-600 peer-checked:before:text-xs peer-checked:before:font-bold peer-checked:before:content-['✓']" />
