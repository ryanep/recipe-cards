...
export const Modal = ({ actionButton, children, title }: ModalProps) => {
  ...
  return (
    <dialog
      className="backdrop-blur-xs fixed left-1/2 top-1/2 m-0 flex w-96 -translate-x-1/2 -translate-y-1/2 flex-col gap-4 rounded-md border border-neutral-400 bg-white/95 text-neutral-900 shadow-lg dark:border-neutral-800 dark:bg-black/90 dark:text-neutral-50"
      open
    >
